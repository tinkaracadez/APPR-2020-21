...
Podatke sem pridobila na statističnem uradu Republike Slovenije, na Eurostatu in na Wikipediji. Dve sta bili v obliki CSV, dve pa v obliki HTML. Urejeni podatki so shranjeni v štirih tabelah.
...
Podoben prikaz kot za slovenske regije sem želela narediti še za evropske države. Tudi tu sem v graf vključila tiste države, ki bolj odstopajo od povprečja. Namesto števila rojenih otrok na splošno sem dodala stolpec s številom otrok na km^2. Od vseh držav je najbolj izstopala Turčija (okrog 53 otrok na km^2), ki je zaradi preglednosti nisem vključila v graf. Veliko otrok je bilo glede na površino rojenih tudi v Gruziji in Azerbaijanu, a je bilo podatkov zelo malo. Presenetile so me velike vrednosti Malte, ki je sicer zelo majhna država. Podobno velja za San Marino, a so tudi tu podatki zelo pomanjkljivi. Slovenija se vrti nekje v povprečju, ki sicer znaša med 1 in 3 otroci na km^2. Daleč najmanjše vrednosti dosega Islandija, sledijo pa ji ostale skandinavske države, ki so si med seboj zelo podobne. 
Tudi tu pa je razviden, a v precej manjši meri, padec števila rojenih otrok. To pa ne velja za Malto, kjer je število rjenih otrok celo naraščalo.
...
Drugi zavihek pa je namenjen prikazu gibanja rojstev za obravnavane evropske države skozi zadnje desetletje, vendar so za nekatere države grafi zaradi pomanjkanja podatkov nepopolni.
